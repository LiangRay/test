...
var tm = (function(t) {
  ...
  function(t, e, n) {
    ...
    (N.finalized = !0),
      (N.render = (t, e, n) => {
        ...
        if (
          (Object(l.b)(t, c, Object.assign({ templateFactory: f(r) }, n)), a)
        ) {
          const t = l.a.get(c);
          l.a.delete(c);
    ...
    const s = new WeakMap(),
      a = (t, e, n) => {
        ...
        void 0 === a &&
          ...
          s.set(e, (a = new o.e(Object.assign({ templateFactory: i.b }, n)))),
          a.appendInto(e)),
          a.setValue(t),
          a.commit();
      };
  ...
  function(t, e, n) {
    ...
    class s extends o.LitElement {
      ...
      click(t) {
        t && t.stopPropagation(),
          this.dispatchEvent(
            new CustomEvent("click", { bubbles: !0, composed: !0 })
          );
      }
      render() {
        return o.html`
    ...
    r([o.property({ type: String })], s.prototype, "label", void 0),
      r([o.property({ type: String })], s.prototype, "iconType", void 0),
      r([o.property({ type: Boolean })], s.prototype, "disabled", void 0),
  ...
  function(t, e, n) {
      ...
      render() {
        ...
        return i.html`
            ...
            <div id="container" style="width: ${t}px; height: ${e}px;">
                <button id="crop-button" class="webcam-button" @click=${
                  this.__toggleCrop
                }>
                    ${i.svg`
                        <svg
                ...
                <button id="flip-button" class="webcam-button" @click=${
                  this.flipWebcam
                }>
                    ${i.svg`
                        <svg
    ...
    (d.defaultCrop = { left: 0, top: 0, width: 265, height: 265 }),
      o(
        [i.property({ type: Boolean, reflect: !0 })],
        d.prototype,
        "edit",
        void 0
      ),
      o(
        [i.property({ type: Number, reflect: !0 })],
        d.prototype,
        "cropLeft",
        void 0
      ),
      o([i.property({ type: Number })], d.prototype, "cropTop", void 0),
      o([i.property({ type: Number })], d.prototype, "cropWidth", void 0),
      o([i.property({ type: Number })], d.prototype, "cropHeight", void 0),
      o([i.property({ type: Number })], d.prototype, "minCropWidth", void 0),
      o([i.property({ type: Number })], d.prototype, "minCropHeight", void 0),
      o(
      ...
      o([i.property({ type: Number })], d.prototype, "aspect", void 0),
      o(
        [i.property({ type: Boolean, reflect: !0 })],
        d.prototype,
        "paused",
  ...
  function(t, e, n) {
    ...
    var r,
      ...
      i = n(58),
      s = n(59),
      a = { requestAnimationFrame: s, cancelAnimationFrame: s.cancel };
    function c() {
      return !0;
    }
    var l = (function(t) {
                ...
                <div id="settings">
                        ...
                        <div class="setting-option">
                            ...
                            <div class="input-holder">
                                <input id="fps" type="number" min="1" max="60" value=${
                                  this.webcamThrottle
                                }
                                    @input=${t => {
                                      const e = t.target;
                                      this.webcamThrottle = parseInt(
                                        e.value,
                                        10
                                      );
                                    }} min="1"/>
                        ...
                        <div class="setting-option">
                            <tm-toggle
                                ...
                                @change=${() =>
                                  (this.holdToRecord = !this.holdToRecord)}>
                            </tm-toggle>
                        </div>

                        <div id="hold-to-record-settings" class=${
                          this.holdToRecord ? "disabled" : ""
                        }>
                            <div class="setting-option">
                                <label for="delay">Delay:</label>
                                <div class="input-holder">
                                    <input id="delay" type="number" min="0" value=${this
                                      .recordDelay / 1e3}
                                        @change=${t => {
                                          this.recordDelay =
                                            1e3 * Number(t.target.value);
                                        }} min="0"/>
                                    seconds
                                </div>
                            </div>
                            ...
                            <div class="setting-option">
                                ...
                                <div class="input-holder">
                                    <input id="duration" type="number" min="0" value=${this
                                      .recordDuration / 1e3}
                                        @change=${t => {
                                          this.recordDuration =
                                            1e3 * Number(t.target.value);
    ...
    (h.middleSlotName = "middle"),
      ...
      (h.lastRecordDuration =
        null !== u.default.getWebcamSetting("recordDuration")
          ...
          : 6e3),
      o([s.property({ type: String })], h.prototype, "buttonLabel", void 0),
      o([s.property({ type: String })], h.prototype, "buttonSVG", void 0),
      o([s.property({ type: Number })], h.prototype, "webcamThrottle", void 0),
      o([s.property({ type: Boolean })], h.prototype, "holdToRecord", void 0),
      o([s.property({ type: Number })], h.prototype, "recordDelay", void 0),
      o([s.property({ type: Number })], h.prototype, "recordDuration", void 0),
      o(
        [s.property({ type: Boolean, reflect: !0 })],
        h.prototype,
        "autoPlay",
        void 0
      ),
      o([s.property({ type: Boolean })], h.prototype, "autoRecord", void 0),
      o(
        [s.property({ type: Boolean, reflect: !0 })],
        h.prototype,
        "settings",
  ...
  function(t, e, n) {
            ...
            (this.__promiseGetWebcam = l
              ...
              .catch(t => {
                console.log(t),
                  (this._isOk = !1),
                  this.dispatchEvent(
                    new CustomEvent("webcamReject", { bubbles: !0 })
                  );
              })
              .then(t => {
                  ...
                  return r
                    ...
                    .then(
                      () => (
                        ...
                        this.dispatchEvent(
                          new CustomEvent("webcamAccept", { bubbles: !0 })
                        ),
                        r
                      )
                    );
    ...
    (d.flip = !0),
      ...
      o([s.property({ type: Number })], d.prototype, "throttle", void 0),
      o(
        [s.property({ type: Number, reflect: !0 })],
        d.prototype,
        "width",
        void 0
      ),
      ...
      o([s.property({ type: String })], d.prototype, "deviceId", void 0),
  ...
  function(t, e, n) {
    ...
    let c = class extends i.LitElement {
      ...
      _handleDelayUpdate(t, e) {
        this._updateFill(e / this.delay),
          this._updateLabel(),
          this.dispatchEvent(new CustomEvent("delayupdate", { bubbles: !0 })),
          e >= this.delay && this._delayLoop.complete();
      }
      _handleDelayComplete() {
        this.dispatchEvent(new CustomEvent("delaycomplete", { bubbles: !0 })),
          this._delayLoop.stop(),
          this._loop.start();
      }
      _handleLoopStart() {
        (this.__isActive = !0),
          this.dispatchEvent(new CustomEvent("start", { bubbles: !0 }));
      }
      _handleLoopStop() {
        (this.__isActive = !1),
          this.dispatchEvent(new CustomEvent("stop", { bubbles: !0 }));
      }
      _handleLoopComplete() {
      ...
      _handleLoopUpdate(t, e) {
        this._updateFill(e / this.duration),
          this._updateLabel(),
          this.dispatchEvent(new CustomEvent("update", { bubbles: !0 })),
      ...
      cancel() {
        return (
          ...
          this._loop.reset(),
          this._updateLabel(),
          this.dispatchEvent(new CustomEvent("cancel", { bubbles: !0 })),
          !0)
        );
      }
      start() {
    ...
    r([i.property({ type: Number })], c.prototype, "delayOnComplete", void 0),
      r([i.property({ type: Boolean })], c.prototype, "cancelable", void 0),
      r([i.property({ type: Number })], c.prototype, "delay", void 0),
      r([i.property({ type: Number })], c.prototype, "duration", void 0),
      r([i.property({ type: Number })], c.prototype, "fps", void 0),
      r(
        [i.property({ type: Boolean, reflect: !0 })],
        c.prototype,
        "hideProgress",
      ...
      r([i.property({ type: String })], c.prototype, "label", void 0),
  ...
  function(t, e, n) {
    ...
    r([o.property({ type: Number })], s.prototype, "value", void 0),
      r([o.property({ type: Number })], s.prototype, "min", void 0),
      r([o.property({ type: Number })], s.prototype, "max", void 0),
      r([o.property({ type: String })], s.prototype, "label", void 0),
      r(
        [o.property({ type: Boolean, reflect: !0 })],
        s.prototype,
        "disabled",
        void 0
      ),
  ...
  function(t, e, n) {
    ...
    (e.assertHasWebRTC = function() {
      ...
      (e.getMicrophoneStream = function(t) {
        return u({ audio: { deviceId: t }, video: !1 }).then(
          t => t,
          () =>
            Promise.reject(
    ...
    class h extends o.LitElement {
      ...
      _handleLoopPlay() {
        return (
          ...
          this._loop && this._loop.stop(),
          (this._loop = new i.Animitter({ fps: this.throttledFrameRate })),
          this._loop.on("update", this._handleLoopUpdate),
          this._loop.start(),
          this
        );
      ...
      _dispatchUpdate(t, e, n) {
        this.dispatchEvent(
          new CustomEvent("update", {
            composed: !0,
            detail: { deltaTime: t, elapsedTime: e, frameCount: n }
          })
        );
      }
    }
    (h.__instances = []),
      r([o.property({ type: Boolean })], h.prototype, "autoplay", void 0),
      r([o.property({ type: Number })], h.prototype, "throttle", void 0),
  ...
  function(t, e, n) {
    ...
    r([o.property({ type: String })], i.prototype, "colors", void 0),
      r([o.property({ type: Number })], i.prototype, "value", void 0),
      r([o.property({ type: Number })], i.prototype, "max", void 0),
      r([o.property({ type: String })], i.prototype, "label", void 0),
      r(
        [o.property({ type: String, reflect: !0 })],
        i.prototype,
        "display",
        void 0
      ),
                  ...
                  [
                    ...
                    i.tidy(function() {
                      ...
                      for (o = 0; o < s.length; o++)
                        a.push({ className: t[s[o]], probability: i[o] });
                      return a;
                    })
                  ]
                );
            ...
            switch (o.label) {
              ...
              case 1:
                return (
                  ...
                  t && 1 === t.version
                    ? ((c = a.getLayer(s)),
                      (l = i.model({ inputs: a.inputs, outputs: c.output })),
      ...
      (e.metadataBrowserHTTPRequest = function(t, e, n) {
        ...
        return (
          ...
          new c(t, a.config.PUBLISH_URL, {
            requestInit: { method: "POST", headers: r }
          })
        );
      });
  },
              ...
              return o(this, function(o) {
                switch (o.label) {
                  ...
                  case 7:
                    return [
                      2,
                      { modelTopology: r, weightSpecs: s, weightData: a }
                    ];
                }
              });
            });
  ...
  function(t, e, n) {
    ...
    r([o.property({ type: Boolean })], i.prototype, "disabled", void 0),
      r([o.property({ type: Boolean })], i.prototype, "hideLabel", void 0),
      r([o.property({ type: Boolean })], i.prototype, "checked", void 0),
      r([o.property({ type: String })], i.prototype, "label", void 0),
  ...
  function(t, e, n) {
    ...
    (e.barGraphPalette = [
      ...
      (e.defaultWizardSchema = {
        ...
        train: { title: "Train", description: "OK, let's train your model!" },
        type: "image"
      });
    class u {
      constructor(t) {
        ...
        n.push(...Object.keys(t).filter(t => n.indexOf(t) < 0)),
          ...
          this.schema.introduction &&
            (this.schema.introduction.title &&
              (this.domElement.introduction.title = this.schema.introduction.title),
            this.schema.introduction.description &&
              (this.domElement.introduction.description = this.schema.introduction.description)),
    ...
    (u.defaultInferenceWebcamSettings = { autoPlay: !0, size: 290 }),
  ...
  function(t, e, n) {
    ...
    let d = class extends i.LitElement {
              ...
              yield this.model.addExample(t, e),
                ...
                this.dispatchEvent(
                  new CustomEvent("sampleadd", {
                    detail: { index: t, name: this.classes[t], sample: e }
                  })
                );
            });
      ...
      loadModel(t = {}) {
        const e = Object.assign({}, { version: 2, alpha: 0.35 }, t);
        return (
          (this.samples = []),
          c
            .createTeachable({ tfjsVersion: "0.0.0", tmVersion: "0.0.0" }, e)
            .then(
              t => (
                (this.model = t),
      ...
      train() {
        return o(this, void 0, void 0, function*() {
          (this.__modelHasBeenTrained = !1),
            ...
            this.stepIndex++,
            console.log(
              `post stepIndex: ${this.stepIndex}, ${this.stepIndex -
                this.classes.length}`
            ),
            this.requestUpdate();
        });
      ...
      renderTrainCard() {
        ...
        return (
          ...
          i.html`
            ...
            <div id="right-content">
                <h2 class="top-drop">${this.stepIndex}. ${
            this.training.title
          }</h2>
      ...
      renderRunCard() {
        ...
        return i.html`
            ...
            <div id="right-content">
                <h2 class="top-drop">${this.stepIndex}. 验证一下</h2>
                <p>
                    现在试着举起你的手, 然后你应该看见the bars move accordingly. 如果没有正常工作, 点击 “上一步” to adjust your examples 或者点击 “完成.”
                </p>
            </div>
        `;
      }
            ...
            <tm-button
                ...
                @click=${() =>
                  o(this, void 0, void 0, function*() {
                    ...
                    const t = h.metadataBrowserHTTPRequest(
                    ...
                    console.log("response", n),
                      (this.shadowRoot.querySelector(
                        "#waiting"
                      ).innerHTML = `name: ${n.name}, token: ${n.token}`),
                      p.addPublished(n);
                  })}></tm-button>
        ...
        return i.html`
            ...
            <ta-card>
                ...
                <div id="navigation" slot="navigation">
                    <div id="cancel">
                        <tm-button label="取消" @click=${() =>
                          (this.open = !1)}></tm-button>
                    </div>
                    <div id="start-over">
                        <tm-button label="Start Over" @click=${() =>
                          console.log("start over")}></tm-button>
                    </div>
                    <div id="middle">
                    ...
                    <div id="back">
                        <tm-button ?disabled=${0 ===
                          this.stepIndex} label="上一步" @click=${() => {
          this.stepIndex > 0 && (this.stepIndex--, this.requestUpdate());
        }}></tm-button>
                    </div>
                    <div id="next">
                        <tm-button ?disabled=${!this.canProgress()} label=${
          0 === this.stepIndex
            ? "开始"
      ...
      updated(t) {
        return (
          t.has("open") &&
            this.dispatchEvent(
              new CustomEvent(this.open ? "open" : "close", { bubbles: !0 })
            ),
          super.updated(t)
        );
      }
    ...
    r(
      ...
      r([i.property({ type: Array })], d.prototype, "classes", void 0),
      r([i.property({ type: Object })], d.prototype, "inputSettings", void 0),
      r([i.property({ type: Object })], d.prototype, "training", void 0),
      r([i.property({ type: Object })], d.prototype, "introduction", void 0),
  ...
  function(t, e, n) {
    ...
    r([o.property({ type: Number })], s.prototype, "steps", void 0),
      r([o.property({ type: Number })], s.prototype, "value", void 0),
  ...
  function(t, e, n) {
    ...
    r([o.property({ type: String })], a.prototype, "color", void 0),
      r([o.property({ type: Array })], a.prototype, "samples", void 0),
      r([o.property({ type: String })], a.prototype, "label", void 0),
      r(
        [o.property({ type: Boolean, reflect: !0 })],
        a.prototype,
        "play",
      ...
      r([o.property({ type: Number })], a.prototype, "fps", void 0),
      r(
        [o.property({ type: Boolean, reflect: !0 })],
        a.prototype,
        "showClassName",
  ...
  function(t, e, n) {
    ...
    class l extends s.LitElement {
      ...
      clearSamples() {
        (this._samples = []),
          ...
          (this._sampleUIDs = []),
          this.dispatchEvent(
            new CustomEvent("clear", { bubbles: !0, composed: !0 })
          );
      }
      _dispatchRecordStart() {
        this.dispatchEvent(
          new CustomEvent("recordstart", { bubbles: !0, composed: !1 })
        );
      }
      _dispatchRecordStop() {
        this.dispatchEvent(
          new CustomEvent("recordstop", { bubbles: !0, composed: !1 })
        );
      }
      __dispatchSample() {
        this._statsElement && this._statsElement.now(),
          this.dispatchEvent(
            new CustomEvent("sample", { bubbles: !0, composed: !1 })
          );
      }
      updated(t) {
        return (
    ...
    r(
      ...
      r([s.property({ type: String })], l.prototype, "label", void 0),
      r([s.property({ type: String })], l.prototype, "buttonLabel", void 0),
      r([s.property({ type: String })], l.prototype, "buttonSVG", void 0),
      r(
        [s.property({ type: Boolean, reflect: !0 })],
        l.prototype,
        "open",
      ...
      r([s.property({ type: Number })], l.prototype, "sampleSize", void 0),
      r([s.property({ type: Boolean })], l.prototype, "runSample", void 0),
      r(
      ...
      r([s.property({ type: Number })], l.prototype, "maxSamples", void 0),
      r(
        [s.property({ type: Boolean })],
        l.prototype,
        "samplesArePlayable",
  ...
  function(t, e, n) {
    ...
    r([i.property({ type: String })], c.prototype, "value", void 0),
      r([i.property({ type: String })], c.prototype, "kind", void 0),
      r([i.property({ type: Boolean })], c.prototype, "hideWhenEmpty", void 0),
    ...
    var d = (function(t) {
      ...
      return (
        ...
        (e.prototype.convertToTfDataset = function() {
          ...
          return {
            trainDataset: a.data.zip({ xs: i, ys: c }),
            validationDataset: a.data.zip({ xs: s, ys: l })
          };
        }),
                ...
                switch (s.label) {
                  case 0:
                    if (
                      ...
                      (l = this.seed
                        ? a.initializers.varianceScaling({ seed: 3.14 })
  ...
  function(t, e, n) {
    ...
    var s = n(8),
      a = n(40),
      c = { facingMode: "user", frameRate: 24 },
      l = (function() {
        function t(t, e, n) {
          void 0 === t && (t = 400),
            void 0 === e && (e = 400),
